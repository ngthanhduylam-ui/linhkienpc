        ...
        <div className="mt-3 rounded-md border border-brand-200 bg-white px-3 py-3">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              {selectedCustomer.phone && <p className="mt-1 text-sm text-slate-700">{selectedCustomer.phone}</p>}
              {selectedCustomer.address && <p className="mt-1 text-xs text-slate-500">{selectedCustomer.address}</p>}
            </div>
            <button
              type="button"
              onClick={() => {
