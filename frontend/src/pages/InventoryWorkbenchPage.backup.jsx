  ...
  return (
    <section className="space-y-5">
      ...
      {showCreateForm && !selectedProduct && (
        <div className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-slate-900/40 px-4 py-6">
          <div className="w-full max-w-3xl rounded-xl border border-slate-200 bg-white p-5 shadow-xl" role="dialog" aria-modal="true" aria-labelledby="create-product-title">
              <h3 id="create-product-title" className="text-base font-semibold text-slate-900">{"Tạo sản phẩm mới"}</h3>
