ALTER TABLE products
  ADD COLUMN sale_price DECIMAL(15,0) NULL AFTER spec_summary,
  ADD CONSTRAINT chk_products_sale_price_non_negative CHECK (sale_price IS NULL OR sale_price >= 0);

ALTER TABLE stock_vouchers
  ADD COLUMN total_amount DECIMAL(15,0) NULL AFTER note,
  ADD CONSTRAINT chk_stock_vouchers_total_amount_non_negative CHECK (total_amount IS NULL OR total_amount >= 0);
